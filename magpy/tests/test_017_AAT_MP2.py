...
def test_AAT_MP2_H2DIMER():
    ...
    e_conv = 1e-12
    r_conv = 1e-12
    I_00, I_0D, I_D0, I_DD = AAT.compute('MP2', r_disp, b_disp, e_conv=e_conv, r_conv=r_conv, normalization='intermediate')
...
def test_AAT_MP2_H2DIMER_NORM():
    ...
    e_conv = 1e-12
    r_conv = 1e-12
    I_00, I_0D, I_D0, I_DD = AAT.compute('MP2', r_disp, b_disp, e_conv=e_conv, r_conv=r_conv, normalization='full')
